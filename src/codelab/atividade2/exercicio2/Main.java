package codelab.atividade2.exercicio2;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean contemElemento = buscar(array, valor);
    ...
    private static boolean buscar(int[] array, int valor) {
        int pontoFim = array.length;
        int pontoInicio = 0;
        ...
        } while (pontoFim != pontoInicio && pontoFim - 1 != pontoInicio);
